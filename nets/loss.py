...
def yolo_anchor_decode(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    box_class_confidence = K.sigmoid(feats[..., 5:])

    # ------------------------------
    # return grid, feats, box_xy, box_wh for loss calculation
    # return box_xy, box_wh, box_confidence, box_class_confidence at prediction
    # ------------------------------
    if calc_loss == True:
        return grid, feats, box_xy, box_wh
    return box_xy, box_wh, box_confidence, box_class_confidence
